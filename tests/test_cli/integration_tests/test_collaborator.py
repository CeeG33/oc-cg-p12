...
def test_collaborator_CRUD_successful(monkey_token_check_management, fake_department_management, capsys):
    collaborator.create(
                first_name="Test",
                name="Collaborator",
                email="test@test.fr",
    ...
    deleted_collaborator = Collaborator.get_or_none(Collaborator.email == "test@test.fr")
