...
def test_creation_successful(monkey_token_check_correct_sales, fake_company, fake_collaborator_sales, capsys):
...
def test_creation_with_optional_arguments_successful(monkey_token_check_correct_sales, fake_company, fake_collaborator_sales, capsys):
    first_name = "Capitaine"
    name = "Crabs"
    email = "capitaine.crabs@ocean.com"
    phone = "0254659878"
...
def test_creation_not_authorized(monkey_token_check_support_gargamel, fake_company, capsys):
    first_name = "Capitaine"
    name = "Crabs"
    email = "capitaine.crabs@ocean.com"
    phone = "0254659878"
...
def test_creation_fails_if_not_authenticated(monkey_token_check_false, fake_company, capsys):
    first_name = "Capitaine"
    name = "Crabs"
    email = "capitaine.crabs@ocean.com"
    phone = "0254659878"
