...
def test_contract_creation_with_wrong_creation_date(fake_client, fake_collaborator_sales):
    client = fake_client.id
    collaborator = fake_collaborator_sales.id
    total_sum = 15399
    creation_date = "Wrong"
...
def test_contract_creation_with_wrong_signed_field(fake_client, fake_collaborator_sales):
    client = fake_client.id
    collaborator = fake_collaborator_sales.id
    total_sum = 15399
    signed = "Wrong"
